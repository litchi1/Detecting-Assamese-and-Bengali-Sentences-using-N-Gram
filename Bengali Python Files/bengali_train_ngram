...
file_list = ['bengali_train_corpus_one_word.txt', 'bengali_train_corpus_two_word.txt',
             'bengali_train_corpus_three_word.txt']

ngram = int(input('Enter the value of ngram:: '))

with open(os.path.join(save_path + 'bengali_train_corpus.txt'), 'r', encoding='utf-8') as rf:
